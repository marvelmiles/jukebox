...
import MeIcon from "../assets/images/album-cover-sm.jpg";
...
export const Sidebar = ({ width, height, navMinHeight = "" }) => {
  ...
  return (
    <>
      ...
      >
        <Stack variant="brand" color="dark">
          <Stack>J</Stack>
        ...
        >
          <List disablePadding>
            ...
            {[
              ...
              <ListItemButton key={index} to={li.to}>
                <ListItem key={index} disableGutters>
                  <ListItemIcon>
                    <li.icon />
                  </ListItemIcon>
                  <ListItemText primary={li.element} />
                </ListItem>
              </ListItemButton>
            ))}
          </List>
          ...
          <List disablePadding>
            ...
            {[
              {
                to: "/u/library/recent-plays",
                element: "Recent",
                icon: Sort,
              },
              {
                to: "/u/library/favourites/song",
                element: "Favourites",
                icon: Sort,
              },
              {
      ...
      >
        ...
        >
          <Stack
            ...
            justifyContent={orderOnly ? "space-between" : "normal"}
          >
            <Button
              sx={{
                ..._styles.iconTextBox,
            ...
            >
              <Typography component="span">(34 albums)</Typography>
            </Button>
...
export const Header = ({
  ...
  return (
    ...
    >
      ...
      >
        <Stack sx={{ flexGrow: 1 }} justifyContent="normal">
          <IconButton>
            <KeyboardArrowLeft />
          </IconButton>
          <Tabs
